...
# Definizione menu
MENU_CRIT_ASS = (
    (PREZ_PIU_BASSO, "Prezzo pi&ugrave; basso"),
    (OFF_PIU_VANT, "Offerta pi&ugrave; vantaggiosa"),
)

MENU_VALUTA = ((EURO, "EUR"), (POUND, "GBP"), (DOLLAR, "USD"), (SFR, "SFR"))

MENU_MOD_ACQ = (
    (TRATT_MEPA_40, "Trattativa diretta MePA sotto 40k€"),
...
TAB_ALLEGATI = {
    ALL_GENERICO: ("A99_", "Documento generico", ALL_NAME),
    ...
    ALL_DECIS_FIRM: (
        "A24_Decisione_Firmata",
        "Decisione di contrarre con firma digitale",
        ALL_SING,
    ),
    ALL_LISTA_DETT: (
        "A30_Lista_Dettagliata",
        "Lista dettagliata da allegare all'ordine",
        ALL_SING,
    ),
    ALL_STIPULA: ("A28_Documento_Stipula", "Documento di stipula", ALL_SING),
    ALL_OBBLIG: (
        "A30_Obbligaz_Giurid_Perfezionata",
...
TABELLA_PASSI = {
    ...
    CdP.INI: (
        "Genera progetto",  # Descrizione stato
...
TESTO_INVIO_PUBBLICAZIONE = """
In allegato {tipo} riguardante la pratica N. {pratica} per pubblicazione
"""

DECIS_PUBB = "la decisione firmata"
CIG_PUBB = "il CIG"
...
in allegato alla presente si trasmette il documento di stipula relativo alla procedura{id} avente per oggetto: {descrizione}
"""
...
FILEDIR = os.path.join(
    PKG_ROOT, AUXFILEDIR
)  # path della directory dei files ausiliari"
