...
Decisione di contrarre del ((( pratica.data_decisione ))) – Adesione a convenzione per
la fornitura di ((( pratica.descrizione_acquisto )))
...
\textbf{CONSIDERATA~} la necessità di provvedere alla fornitura di
((( pratica.descrizione_acquisto ))) per INAF – Osservatorio Astrofisico di Arcetri;
...
comunitario suddivisa in n. XXXX Lotti geografici e indetta con Bando di gara pubblicato
nella Gazzetta Ufficiale della Repubblica Italiana n. XXXX del XX/XX/XXXX e nella
Gazzetta Ufficiale dell’Unione Europea n. XXXX del XX/XX/XXXX con l’Operatore Economico
...
è il numero XXXX – CIG (Master): ((( pratica.cig_master )));

\textbf{RITENUTO~} di aderire alla Convenzione Consip XXXX, mediante Ordine diretto
di acquisto alla società ((( pratica.fornitore_nome ))) con sede legale in
((( pratica.fornitore_sede ))), Cod.Fisc.: (((pratica.fornitore_codfisc ))),
Part.IVA: ((( pratica.fornitore_partiva ))), aggiudicataria del Lotto numero lotto;
...
\textbf{VISTO~} il parere del Ministero delle Infrastrutture e Trasporti 
Cod. id. 1888 – data ricezione 06/04/2023, a mente del quale: \textit{“La stazione appaltante 
che aderisce ad una convenzione Consip non è tenuta ad effettuare la verifica dei requisiti
dell’operatore economico, in quanto questa è già stata prontamente effettuata da Consip al 
momento della stipula della convenzione stessa”};

\textbf{PRESO ATTO~} che la spesa per l'acquisto di suddetta fornitura è di Euro ((( pratica.costo_netto ))),
al netto di IVA; 
...
Art. 4: Di autorizzare l'affidamento diretto in adesione a Convenzione Consip 
della fornitura di ((( pratica.descrizione_acquisto ))) a
