...
Decisione di contrarre – Affidamento diretto
	della fornitura di ((( pratica.descrizione_acquisto )))
%%CIG: ((( pratica.numero_cig )))
...
\end{center}
\textbf{VISTA~}
la Legge 7 agosto 1990, numero 241, e successive modifiche
...
\textbf{VISTO~}
il Decreto Legislativo 30 marzo 2001, numero 165, e
...
\textbf{VISTO~}
il Decreto Legislativo 30 giugno 2003, numero 196, con
il quale è stato adottato il \textbf{"Codice in materia di protezione dei dati
personali"};

\textbf{VISTO~}
il "Regolamento (UE) 2016/679 del Parlamento e del
...
\textbf{VISTO~}
il Decreto Legislativo 10 agosto 2018, numero 101,
...
\textbf{VISTO~}
il Decreto Legge 6 luglio 2011, numero 98, che contiene
...
\textbf{VISTO~}
il Decreto Legge 7 maggio 2012, numero 52, che contiene
...
\textbf{VISTO~}
il Regolamento sull'Amministrazione, sulla Contabilità
...
\textbf{VISTO~}
lo Statuto dell'INAF, adottato dal Consiglio di
...
\textbf{VISTO~}
il vigente "Piano Triennale per la Informatica nella Pubblica
Amministrazione";
...
\textbf{VISTO~}
il Decreto Legislativo 31 marzo 2023, numero 36, con il
quale:
\begin{itemize}
...
\textbf{VISTI~}
gli articoli da 19 a 36 del D. Lgs. 31 marzo 2023 n. 36,
...
\textbf{VISTO~}
l'articolo 49 del Decreto Legislativo 31 marzo 2023,
numero 36, rubricato "Principio di rotazione degli affidamenti";


\textbf{VISTO~}
l'articolo 50 del Decreto Legislativo 31 marzo 2023,
...
\textbf{VISTO~}
il Regolamento delegato (UE) 2025/2150 della Commissione, del 22 ottobre
2025, che modifica la direttiva 2014/25/UE del Parlamento europeo e
del Consiglio per quanto riguarda le soglie degli appalti di forniture,
servizi e lavori e dei concorsi di progettazione per gli anni 2026-2027;

\textbf{VISTO~}
in particolare l'articolo 1 del Regolamento Delegato (UE) 2025/2150
della Commissione che stabilisce che "L'articolo 15 della direttiva
2014/25/UE è così modificato:



\begin{enumerate}
\item[a)]  alla lettera a), «443~000~EUR» è sostituito da «432~000~EUR»;
\item[b)]  alla lettera b), «5~538~000~EUR» è sostituito da «5~404~000~EUR».";
\end{enumerate}


\textbf{VISTO~}
il Regolamento delegato (UE) 2025/2151 della Commissione, del 22 ottobre
2025, che modifica la direttiva 2014/23/UE del Parlamento europeo e
del Consiglio per quanto riguarda le soglie delle concessioni per gli
anni 2026-2027;


\textbf{VISTO~}
in particolare l'articolo 1 del Regolamento delegato (UE) 2025/2151
della Commissione che stabilisce che "All'articolo 8, paragrafo 1,
della direttiva 2014/23/UE, «5~538~000~EUR» è sostituito da «5~404~000~EUR».";


\textbf{VISTO~}
il Regolamento delegato (UE) 2025/2152 della Commissione, del 22 ottobre
2025, che modifica la direttiva 2014/24/UE del Parlamento europeo e
del Consiglio per quanto riguarda le soglie degli appalti pubblici di
forniture, servizi e lavori e dei concorsi di progettazione per gli
anni 2026-2027;


\textbf{VISTO~}
in particolare l'articolo 1 del Regolamento delegato (UE) 2025/2152
della Commissione che stabilisce che "La direttiva 2014/24/UE è
così modificata:
...
\begin{enumerate}
\item[a)] alla lettera a), «5~538~000~EUR» è sostituito da «5~404~000~EUR»;

\item[b)] alla lettera b), «143~000~EUR» è sostituito da «140~000~EUR»;

\item[c)] alla lettera c), «221~000~EUR» è sostituito da «216~000~EUR»;
\end{enumerate}
...
\item[b)] alla lettera b), «221~000~EUR» è sostituito da «216~000~EUR».";
\end{enumerate}
...
\textbf{VISTO~}
l'articolo 15 del Decreto Legislativo 31
marzo 2023, numero 36, "Responsabile unico del progetto (RUP)" e
l'allegato I.2 al medesimo Decreto "Attività del RUP";

\textbf{CONSIDERATA~}
L'assenza di una convenzione in ambito Consip;


\textbf{VISTO~}
l'esito della preliminare
...
\textbf{CONSIDERATO~}
che da preliminare e informale indagine
...
\textbf{RITENUTO~}
di potere procedere, anche nell’ottica di ottimizzare i
tempi di realizzazione del suddetto progetto, mediante affidamento diretto;

\textbf{CONSIDERATO~}
che l'Operatore Economico individuato
...
\textbf{RITENUTO~}
di potere avviare su sopramenzionata piattaforma di
...
\textbf{PRESO ATTO~}
che in data ((( pratica.data_negoziazione ))) veniva
...
\textbf{RILEVATO~}
che in data  ((( pratica.data_offerta )))
...
\textbf{ACQUISITE~}	le dichiarazioni sostitutive di atto di notorietà
richieste dalla vigente normativa in materia di appalti pubblici relativamente
ad affidamenti di importo inferiore a Euro 40.000,00; 
...
\textbf{RITENUTO~}
che in relazione all'oggetto dell'affidamento il contratto collettivo
nazionale di lavoro applicabile sia il (((pratica.ccnl))), in quanto coerente con
il settore merceologico e le mansioni richieste per l'esecuzione
dell'appalto;

\textbf{PRECISATO~}
che tale scelta è motivata dal fatto che il (((pratica.ccnl))) è comunemente
applicato alle imprese operanti nel settore e garantisce il rispetto
delle condizioni economico-normative previste dalla normativa vigente;

\textbf{CONSIDERATO~}
che l'Operatore economico ha indicato di applicare al personale impiegato
nell'esecuzione del presente appalto, il (((pratica.ccnl)));

\textbf{RITENUTO~}
che l'applicazione del suddetto (((pratica.ccnl))) garantisca il rispetto dei minimi
salariali e delle condizioni di lavoro previste dalla legge;

\textbf{VISTA~}
la proposta di aggiudicazione del Responsabile Unico del Progetto;

\textbf{CONSIDERATO~}
che, ai sensi dell'articolo 1 del
...
\textbf{VISTA~}
la delibera di approvazione del Bilancio di previsione
dell'Istituto Nazionale di Astrofisica per l'esercizio finanziario
in corso;

\textbf{ACCERTATA~}
la disponibilità finanziaria nei pertinenti
Capitoli di Spesa del predetto Bilancio;

\textbf{VISTA~}
la Legge del 13 agosto 2010 numero 136	e il
...
\textbf{PRESO ATTO~}
delle novità in materia di imposta di bollo introdotte dal "Nuovo Codice degli Appalti Pubblici";

\textbf{VISTO~}
l’Allegato I.4 al Decreto Legislativo 31 Marzo 2023 n. 36 (“Imposta
di bollo relativa alla stipulazione del contratto”);

\textbf{VISTA~}
la comunicazione dell'Agenzia delle Entrate del 28
...
\textbf{VISTA~}
la Circolare dell'Agenzia delle Entrate del 22 luglio
...
\textbf{VISTA~}
la disponibilità sull'Ob. Fu. (Funzione Obiettivo)
in seguito richiamato in parte dispositiva;

\textbf{RITENUTO~}
quindi che vi siano i presupposti normativi e
...
\textbf{VALUTATA~}
la necessità di provvedere all'acquisizione di quanto richiesto;
...
al netto di Imposta sul Valore Aggiunto.
...
nei termini previsti dall'articolo 120 del Decreto Legislativo
...
if pratica.dec_firma_vicario *)), che nei confronti del Direttore Vicario
((* endif *)):
