%% Template: decisione-ub143k.tex. Version 1.0
...
((* if debug *))
\begin{quotation}
	\textbf{DEBUG:} template = \texttt{decisione-ub143k.tex}
\end{quotation}
((* endif *))
...
Art. 4: Di autorizzare l'affidamento diretto della fornitura di
...
dell'Osservatorio((* if pratica.dec_firma_vicario *)), che nei confronti 
del Direttore Vicario ((* endif *)):
