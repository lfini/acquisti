...
%% Template: determinaB.tex - vers. 1.0
...
\item[Art. 1:]	di procedere all'aggiudicazione definitiva a favore della ditta
                ((( pratica.nome_fornitore ))) - ((( pratica.ind_fornitore )))
...
\item[Art. 2:] 	di stabilire nell'importo di ((( pratica.str_prezzo_gara )))((* if pratica.str_oneri_it *)),
		pi\`u ((( pratica.str_oneri_it ))) per oneri di sicurezza, ((* endif *))
...
\item[Art. 4:] 	L'importo del contratto dovr\`a essere impegnato sulla competenza dell'esercizio
                su cui graver\`a il costo dello stesso.
\end{list}

\vspace{0.5cm}


Firenze, l\`i ((( pratica.data_determina_b )))
