%% Template: rdo-tm40k.tex Version 1.0
...
((* if debug *))
\begin{quotation}
	\textbf{DEBUG:} template = \texttt{rdo-tm40k.tex}
\end{quotation}
((* endif *))
...
%%\textbf{((* if pratica.numero_cig *))- CIG: ((( pratica.numero_cig )))((* endif *))}
\textbf{((* if pratica.numero_cup *))- CUP: ((( pratica.numero_cup )))((* endif *))}
...
In ossequio all'art. 53, comma 4, del Decreto Legislativo 31 marzo 2023 
n. 36, \`e dovuta la prestazione di garanzia definitiva per l'esecuzione 
dei contratti, pari al 5\% (cinque per cento) dell'importo contrattuale, 
da prestare entro e non oltre il giorno precedente a quello della stipula 
del contratto, comunicato all'affidatario.

Tuttavia, la Stazione Appaltante, avvalendosi della facoltà\`a insindacabile
riconosciutale dal medesimo art. 53, comma 4, del D.Lgs. n. 36/2023, 
\textbf{rinuncia espressamente a richiedere la costituzione della garanzia
definitiva}, esonerando pertanto l'aggiudicatario dall'obbligo di prestare
detta garanzia ai fini della stipula del contratto.

Tale determinazione è adottata in considerazione dei seguenti elementi:
\begin{itemize}
	\item
	\textbf{Esiguità del valore economico del contratto}, tale da non
	giustificare i costi e gli oneri amministrativi connessi alla
	costituzione e gestione della garanzia, risultando questi sproporzionati
	rispetto all'entità dell'affidamento;
	\item
	\textbf{Semplicità e limitata complessità esecutiva} della prestazione
	oggetto del contratto, che non comporta particolari rischi di inadempimento
	tali da rendere necessario uno strumento di presidio finanziario;
	\item
	\textbf{Esigenze di semplificazione procedimentale}, in linea con i
	principi di proporzionalit\`a, buon andamento ed economicit\`a dell'azione
	amministrativa di cui agli artt. 1 e 2 del D.Lgs. n. 36/2023.
\end{itemize}
...
DIRETTO FORNITURA DI (((pratica.descrizione_acquisto)))}
%%\textbf{((* if pratica.numero_cig *)) - CIG: ((( pratica.numero_cig )))((* endif *))}
\textbf{((* if pratica.numero_cup *)) - CUP: ((( pratica.numero_cup )))((* endif *))},
...
Il concorrente predispone il Documento di Gara Unico Europeo (DGUE/ESPD)
procedendo alla redazione dello stesso, mediante compilazione e download 
del modulo sulla piattaforma UE:

https://espd.eop.bg/espd-web/filter?lang=it

previa importazione del file in formato “.xml” allegato alla presente
richiesta di offerta unitamente alle istruzioni di importazione,
compilazione e download. Avvalendosi di questa opzione il modulo potrà
indifferentemente essere redatto in lingua italiana o in lingua inglese. 

In alternativa, l'Operatore Economico potrà rilasciare le dichiarazione
necessarie compilando il  file in formato PDF del Documento di Gara Unico
Europeo, anch'esso allegato alla presente richiesta.
