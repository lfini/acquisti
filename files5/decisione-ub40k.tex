...
per la gestione delle gare dematerializzate denominato "UBUY"
(\texttt{http://inaf.ubuy.cineca.it/PortaleAppalti/it/homepage.wp});
...
\textbf{PRESO ATTO~} che in data ((( pratica.data_gara ))) veniva
 avviata sulla menzionata piattaforma di e-procurement la procedura -
 id gara ((( pratica.id_gara ))), con termine di
