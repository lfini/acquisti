...
\begin{flushright}
Decisione N. ((( pratica.numero_determina_a )))
\end{flushright}

\begin{center}
\framebox{%
\begin{minipage}{0.9\linewidth}
Decisione di contrarre del ((( pratica.data_determina_a ))) – Affidamento diretto di oggetto
...
((* endfor *))
\hline
	\textbf{Totale} & & && \textbf{(((pratica.costo_totale)))} \\
\end{tabular}
\end{quote}

A gravare su Ob.~Fu. numero ((( pratica.cram ))) – Responsabile dei
Fondi: ((( pratica.nome_responsabile )))

Art. 4: Di autorizzare l’affidamento diretto oggetto a
