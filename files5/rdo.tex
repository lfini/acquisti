...
\textit{e-procurement "MePA"} (https://www.acquistinretepa.it/),
...
L'offerta dovrà indicare in cifre e in lettere il prezzo offerto, al
...
ricezione dell'ordine. Si richiede la disponibilità dell'Operatore
Economico a consegnare la fornitura in oggetto per fine marzo 2024,
stanti i concomitanti lavori per l'implementazione dei locali dove la
fornitura in oggetto dovrà, in ultima analisi, trovare collocazione.
